    ...
    <div>
      ...
      <div className="flex flex-col h-screen justify-between">
        ...
        <main className="max-w-7xl mx-auto text-center mb-auto">
          ...
          <h2>Decentralized Universal Data Licensed Music Marketplace</h2>
          <h2 className="text-xl font-medium mb-12">
          <span>Forever Bound. Woven in Sound.</span> {' '}

           
            <span className="text-blue-500">Support artists in gaining ownership and control over their music</span>
          </h2>
